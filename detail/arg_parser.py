...
class ArgParser(argparse.ArgumentParser):
    def __init__(self):
        ...
        grades_parser = sub_parsers.add_parser('grades',
                                              help='Submits all grades of the specified gradebook file')

        grades_parser.add_argument('gradebook_file',
                                   metavar='gradebook_file',
                                   help='A gradebook file as generated by `artemis-cli repos ...` only with all grades entered :)')
